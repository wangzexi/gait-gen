...
packed = pack_padded_sequence(
    padded, lens, batch_first=True, enforce_sorted=False)
print(f' [1] packed: \n{packed}\n')
...
pad_embed_pack = pack_padded_sequence(
    pad_embed, lens, batch_first=True, enforce_sorted=False)
...
pad_embed_pack_lstm_pad = pad_packed_sequence(
    pad_embed_pack_lstm[0], batch_first=True)
